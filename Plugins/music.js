    ...
    handler: async ({ sock, m, sender, args, contextInfo }) => {
        try {
            ...
            await sock.sendMessage(sender, {
                text: '🔄 *ZENO MD Bot Fetching your audio... Please wait...*',
                contextInfo: contextInfo
            }, { quoted: m });
            ...
            await sock.sendMessage(sender, {
                ...
                caption: `LUCIFER THE ZENO MD BOT
╭═════════════════⊷
║ 🎶 *Title:* ${songData.title}
║ 🎤 *Artist:* ${songData.artist}
║ 🔗 THANK YOU SORRY NO URL TO BE SHARED
╰═════════════════⊷
*Powered by ZENO MD BOT*`,
                contextInfo: contextInfo
            }, { quoted: m });
            ...
            await sock.sendMessage(sender, {
                text: '✅ *ZENO MD – World-class bot just successfully sent you what you requested! 🎶*',
                contextInfo: contextInfo
            }, { quoted: m });
