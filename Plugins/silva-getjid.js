const jidThumbnail = 'https://files.catbox.moe/x4xxwc.jpg';
...
`.trim();
            ...
            await sock.sendMessage(sender, {
                ...
                contextInfo: {
                    externalAdReply: {
                        title: 'Zeno MD JID Tool',
                        body: 'Fetch and manage WhatsApp JIDs easily!',
                        mediaUrl: 'https://zeno.asia, // your site or GitHub
                        mediaType: 1,
                        sourceUrl: 'https://asia.asia,
                ...
                await sock.sendMessage(sender, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            ...
                            body: 'Fetched by Zeno MD',
                            mediaUrl: 'https://zeno.asia',
                            mediaType: 1,
                            sourceUrl: 'https://zeno.asia',
                            thumbnailUrl: jidThumbnail,
