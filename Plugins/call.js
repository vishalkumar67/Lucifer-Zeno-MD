const { generateWAMessageFromContent } = require('@Luciferzeno/baileys');
const os = require('os');
...
module.exports = {
    ...
    tags: ['main'],
    description: 'ZENO MD support panel with Nairobi time',
    handler: async ({ sock, m, sender, contextInfo }) => {
        try {
            ...
            const message = {
                text: `『 *Zeno MD Bot* 』\n© 2025 *Lucifer-zeno Inc*\n\n⏰ *${nairobiTime}*\n📅 *${nairobiDate}*`,
                footer: "Swipe left/right for options ▼",
                title: "LUCIFER ZENO PANEL",
            ...
            sock.ev.on('messages.upsert', async ({ messages }) => {
                ...
                if (selected === '#call' || selected === '#contact') {
                    ...
                    await sock.sendMessage(
                        ...
                        {
                            contacts: {
                                displayName: "Lucifer Zeno",
                                contacts: [{
                                    displayName: "Lucifer Zeno Support",
                                    vcard: `BEGIN:VCARD\nVERSION:3.0\nFN: Lucifer Zeno Support\nTEL;type=CELL;type=VOICE;waid=254700143167:+254 700 143167\nEND:VCARD`
                                }]
                            }
                        },
                        { quoted: m }
                        ...
                        sender,
                        {
                            contacts: {
                                ...
                                contacts: [
                                    ...
                                    {
                                        displayName: "Lucifer Zeno Support 2",
