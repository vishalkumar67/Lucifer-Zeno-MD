    ...
    responses: {
        greetings: {
            ...
            replies: [
                ...
                "Hello! ZENO MD Bot at your service."
            ]
        },
        thanks: {
        ...
        botInfo: {
            ...
            replies: [
                "I'm ZENO MD Bot, an advanced WhatsApp assistant created by LUCIFER_ZENO  Tech Inc.",
                "I'm ZENO MD, your helpful WhatsApp assistant!",
                "I'm ZENO MD Bot, designed to make your WhatsApp experience better."
            ]
        },
        creator: {
            patterns: ["who made you", "who created you", "your creator", "your developer"],
            replies: [
                "I was created by Lucifer Zeno Tech Inc. 💀",
                "Zeno Tech Inc. developed me to assist users like you!",
                "I'm a product of Zeno Tech Inc.'s innovation."
            ]
        },
        time: {
...
module.exports = {
    ...
    handler: async ({ sock, m, sender, args, contextInfo, isGroup }) => {
        try {
            ...
            const isAdmin = userNumber === '923113044693'; // Replace with your admin number
