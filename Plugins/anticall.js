...
const defaultSettings = {
    ...
    blockCaller: false,
    notifyAdmin: true,
    autoReply: "🚫 Bhai Calls kr ke tang na kro Massage Bej do😂.",
    blockedUsers: [],
    adminNumber: '923113044693@s.whatsapp.net' // Replace with your admin number
};
                            ...
                            await sock.sendMessage(
                                ...
                                { 
                                    ...
                                    contextInfo: {
                                        externalAdReply: {
                                            title: "Call Blocked",
                                            body: "ZENO MD Anti-Call Protection",
                                            thumbnailUrl: "https://files.catbox.moe/x4xxwc.jpg",
                                            mediaType: 1
                                        }
                                    }
        ...
        try {
            ...
            if (!isAdmin) {
                return sock.sendMessage(
                    sender,
                    { 
                        text: '❌ Bhai Tu Ye CMD Use NHI kr Sagta😂',
