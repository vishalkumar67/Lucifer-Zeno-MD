...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || "۞ 𝘓𝘜𝘊𝘐𝘍𝘌𝘙 ۞ 𝘡𝘌𝘕𝘖 ۞",
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "923113044693",
    OWNER_NAME: process.env.OWNER_NAME || "۞ 𝘓𝘜𝘊𝘐𝘍𝘌𝘙 ۞ 𝘡𝘌𝘕𝘖 ۞",
    DESCRIPTION: process.env.DESCRIPTION || "*۞ 𝘓𝘜𝘊𝘐𝘍𝘌𝘙 ۞ 𝘡𝘌𝘕𝘖 ۞*",
    ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/x4xxwc.jpg",
    LIVE_MSG: process.env.LIVE_MSG || "> ZENO MD IS ACTIVE ⚡",
    ...
    AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*👀 Seen by ZENO MD ✅*",
