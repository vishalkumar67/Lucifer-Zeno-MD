# Contributing to Zeno MD Bot  v5

Thank you for considering contributing to Zeno MD Bot! Your contributions help make this project better for everyone.  
...
2. **Clone the Repository** – Clone your fork locally using:  
    ```sh
    git clone https://github.com/vishalkumar67/Lucifer-Zeno-MD.git
    cd zeno-md-bot
    ```
